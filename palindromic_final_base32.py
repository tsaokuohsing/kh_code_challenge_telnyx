...
def convert_base(number, base):
    ...
    base_string = '0123456789ABCDEFGHIJKLMNOPQRTUVWXYZ'
    if number < base:
...
if __name__ == '__main__':
    ...
    while count < int(numpali):
        ...
        if(minimal_palindrome !=-1):
           ...
           print ('The first ' + str(count+1) +' positive palindrome number is {n} for the minimal base {b} (up to base 32)'.format(n=number, b=base))
           number +=1
           count +=1
        else:
           number +=1
